...
public class SistemaHospitalarMain {
    ...
    public static void main(String[] args) {
        ...
        private static void processarGeracaoDeNotaFiscal(Connection conexao, int idFatura, GerenciadorFiscal servico) 
            ...
            System.out.println("\nFatura localizada com sucesso! Iniciando processamento fiscal...");
        ...
        private static void gravarNotaFiscalNoBanco(Connection conexao, NotaFiscal nota) throws SQLException {
            ...
            try (PreparedStatement declaracaoSQL = conexao.prepareStatement(sqlInsert)) {
                ...
                declaracaoSQL.setString(2, nota.getForma_pagamento());
                declaracaoSQL.setBigDecimal(3, nota.getIss());
                declaracaoSQL.setBigDecimal(4, nota.getPis());
                declaracaoSQL.setBigDecimal(5, nota.getCofins());
                declaracaoSQL.setBigDecimal(6, nota.getIrpj());
                declaracaoSQL.setBigDecimal(7, nota.getCsll());
